...
class Config:
    ...
    BOT_TOKEN: str = os.getenv("BOT_TOKEN", "7578490063:AAHQDkFc_oBkTiAUlMVGcj4ferI0rb0DVrk")
    ...
    BOT_OWNER_ID: List[int] = [int(x) for x in os.getenv("BOT_OWNER_ID", "5505135072").split()]
